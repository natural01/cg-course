...
{
public:
	// Ãåíåðèðóåì èìÿ äëÿ áóôåðíîãî îáúåêòà
	void Create()
	{
		if (m_bufferId == 0)
		{
	...
	// Âîçâðàùàåì èäåíòèôèêàòîð áóôåðíîãî îáúåêòà
	operator GLuint()const
	{
		return m_bufferId;
	}

	// "Îòñîåäèíÿåì" áóôåðíûé îáúåêò îò òåêóùåãî ýêçåìïëÿðà êëàññà
	GLuint Detach()
	{
...
protected:
	...
	// Äåëàåì áóôåðíûé îáúåêò àêòèâíûì
	void BindTo(GLenum target)const
	{
		glBindBuffer(target, m_bufferId);
	}

	// Çàäàåì èäåíòèôèêàòîð áóôåðíîãî îáúåêòà
